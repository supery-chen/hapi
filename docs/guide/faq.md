...
HAPI is a local-first, self-hosted platform for running and controlling Codex remotely. It lets you start coding sessions on your computer and monitor/control them from your phone.
