export default {
  ...
  'newSession.permissionMode.default.desc': 'Workspace-write sandbox with on-request approvals.',
  'newSession.permissionMode.safeYolo': 'Safe Yolo',
  'newSession.permissionMode.safeYolo.desc': 'Workspace-write sandbox with automatic escalation only on failure.',
  'newSession.permissionMode.yolo': 'Yolo',
  'newSession.permissionMode.yolo.desc': 'Danger-full-access with no approval prompts.',
  ...
  'terminal.groupCount': '{n} terminal message{s}',
  'terminal.toolGroupCount': '{n} terminal card{s}',
  ...
  'composer.insertAt': 'Insert @',
  'composer.insertSlash': 'Insert /',
  ...
  'misc.jumpToBottom': 'Jump to latest',
