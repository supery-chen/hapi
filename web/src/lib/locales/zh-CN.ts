export default {
  ...
  'newSession.permissionMode.default.desc': '工作区可写沙箱，按需审批。',
  'newSession.permissionMode.safeYolo': 'Safe Yolo',
  'newSession.permissionMode.safeYolo.desc': '工作区可写沙箱，仅在失败时自动提权。',
  'newSession.permissionMode.yolo': 'Yolo',
  'newSession.permissionMode.yolo.desc': '完全访问，不再弹出审批。',
  ...
  'terminal.groupCount': '{n} 条终端消息',
  'terminal.toolGroupCount': '{n} 张终端卡片',
  'terminal.expand': '展开',
  ...
  'composer.abort': '中止',
  'composer.insertAt': '插入 @',
  'composer.insertSlash': '插入 /',
